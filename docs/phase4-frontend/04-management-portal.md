...
├── page.tsx                                # Root redirect (→ dashboard by role)
...
│  🔖 Thẻ tags        │  ← /admin/tags
│  🎯 Placement       │  ← /admin/placement-questions
...
### PAGE: Course View (`/instructor/courses/[courseId]`)
...
│          │  │Thumb │  🟢 Đã duyệt | 📊 Trung cấp | 🏷 Web Dev │
│          │  └──────┘                                            │
│          │                                                      │
│          │  ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────┐│
│          │  │ 👨‍🎓      │ │ ⭐       │ │ 💰       │ │ 📚       ││
│          │  │ 234      │ │ 4.7      │ │ 499,000₫ │ │ 36       ││
│          │  │ Học viên │ │ Đánh giá │ │ Giá      │ │ Bài học  ││
│          │  └──────────┘ └──────────┘ └──────────┘ └──────────┘│
│          │                                                      │
│          │  ── Mô tả ──                                        │
│          │  Nội dung mô tả chi tiết khóa học...                │
│          │                                                      │
│          │  ── Chương trình (read-only) ──                      │
│          │  Section 1: Giới thiệu                               │
│          │    Chapter 1: React là gì? (3 bài)                   │
│          │    Chapter 2: Setup (2 bài)                           │
│          │  Section 2: Components (5 chapters)                  │
│          │                                                      │
│          │  [ ✏️ Chỉnh sửa ]   [ 👥 Học viên ]                  │
│          │                                                      │
└──────────┴──────────────────────────────────────────────────────┘
```
...
### PAGE: Question Bank List (`/instructor/question-banks`)

```
Route:     /instructor/question-banks
Auth:      Instructor
Rendering: Client Component (search, delete)
API:       GET /api/instructor/question-banks + POST + DELETE
```
...
┌──────────┬──────────────────────────────────────────────────────┐
│ Sidebar  │                                                      │
│          │  Ngân hàng câu hỏi                    [ + Tạo mới ]  │
│          │                                                      │
│          │  🔍 [Tìm kiếm...]                                    │
│          │                                                      │
│          │  ┌── DataTable ───────────────────────────────────┐  │
│          │  │ Tên           │ Mô tả        │ Câu hỏi │ Cập nhật│ A │
│          │  ├───────────────┼──────────────┼─────────┼────────┼───┤
│          │  │ React Basics  │ Câu hỏi cơ..│ 25      │ 2 ngày │ ⋯ │
│          │  │ Node.js Quiz  │ Backend qu.. │ 18      │ 1 tuần │ ⋯ │
│          │  │ CSS Advanced  │ Layout, Fl.. │ 12      │ 3 ngày │ ⋯ │
│          │  └───────────────┴──────────────┴─────────┴────────┴───┘
│          │                                                      │
│          │  Actions menu (⋯):                                   │
│          │    👁 Xem chi tiết                                    │
...
### PAGE: Question Bank Detail (`/instructor/question-banks/[bankId]`)

```
Route:     /instructor/question-banks/[bankId]
Auth:      Instructor (owner)
Rendering: Client Component (inline CRUD, tag management, import)
API:       GET /api/instructor/question-banks/:id/questions + POST + PUT + DELETE
           GET /api/instructor/question-banks/:id/tags + POST + DELETE
```
...
│ Sidebar  │                                                      │
│          │  ← React Basics                   [ 📥 Import ]      │
│          │  25 câu hỏi                       [ + Thêm câu hỏi ] │
│          │                                                      │
│          │  Filters: Difficulty [▾ Tất cả]  Tag [▾ Tất cả]     │
│          │                                                      │
│          │  ┌────────────────────────────────────────────────┐  │
│          │  │  Q1. React component lifecycle gồm?            │  │
│          │  │  🟢 Easy | 🏷 react, lifecycle                 │  │
│          │  │  A. Mount ✅  B. Build  C. Compile  D. Link    │  │
│          │  │                                   [ ✏️ ] [ 🗑 ] │  │
│          │  ├────────────────────────────────────────────────┤  │
│          │  │  Q2. useState trả về gì?                       │  │
│          │  │  🟡 Medium | 🏷 react, hooks                   │  │
...
│          │                                                      │
│          │  ── Tags quản lý ──                                  │
│          │  [react ✕] [hooks ✕] [lifecycle ✕] [+ Thêm tag]    │
│          │                                                      │
└──────────┴──────────────────────────────────────────────────────┘

Import Dialog (2-step):
┌─────────────────────────────────────────────────┐
│  Import câu hỏi từ văn bản                 ✕    │
├─────────────────────────────────────────────────┤
│  Step 1: Nhập văn bản                            │
│  ┌─────────────────────────────────────────────┐│
│  │ 1. Câu hỏi đầu tiên?                       ││
...
│  ✅ Phân tích được 5 câu hỏi                    │
│  ⚠ 1 câu hỏi thiếu đáp án đúng                 │
│                                                  │
│  (Preview parsed questions in list)              │
│                                                  │
│  [ ← Quay lại ]             [ Import 4 câu ]    │
└─────────────────────────────────────────────────┘
```
...
### PAGE: Approvals Hub (`/admin/approvals`)

```
Route:     /admin/approvals
Auth:      Admin
Rendering: Server Component
API:       GET /api/admin/stats (pending counts)
```
...
│          │  │ 👨‍🏫 Giảng viên       │ │ 📚 Khóa học          │   │
│          │  │                      │ │                      │   │
│          │  │ 3 đơn chờ duyệt     │ │ 2 khóa chờ duyệt    │   │
│          │  │                      │ │                      │   │
...
│          │  │ 🚨 Báo cáo          │ │ 💸 Rút tiền          │   │
│          │  │                      │ │                      │   │
│          │  │ 5 báo cáo chờ xử lý │ │ 1 yêu cầu chờ       │   │
│          │  │                      │ │                      │   │
│          │  │ [Xem chi tiết →]     │ │ [Xem chi tiết →]     │   │
│          │  └──────────────────────┘ └──────────────────────┘   │
│          │                                                      │
...
### PAGE: Tag Management (`/admin/tags`)

```
Route:     /admin/tags
Auth:      Admin
Rendering: Client Component (search, inline CRUD)
API:       GET /api/admin/tags + POST + PUT + DELETE
```
...
┌──────────┬──────────────────────────────────────────────────────┐
│ Sidebar  │                                                      │
│          │  Quản lý thẻ tags                     [ + Tạo mới ]  │
│          │                                                      │
│          │  🔍 [Tìm kiếm tag...]                                │
│          │                                                      │
│          │  ┌── DataTable ───────────────────────────────────┐  │
│          │  │ Tên tag          │ Slug         │ Sử dụng │ A   │  │
│          │  ├──────────────────┼──────────────┼──────────┼─────┤  │
│          │  │ React            │ react        │ 15       │ ✏ 🗑│  │
...
│          │  └──────────────────┴──────────────┴──────────┴─────┘  │
│          │                                                      │
│          │  ⚠ Không thể xóa tag đang được sử dụng              │
│          │                                                      │
│          │  ← 1  2  3  →                                        │
└──────────┴──────────────────────────────────────────────────────┘
...
### PAGE: Placement Question Management (`/admin/placement-questions`)

```
Route:     /admin/placement-questions
Auth:      Admin
Rendering: Client Component (CRUD, import)
API:       GET /api/admin/placement-questions + POST + PUT + DELETE
```
...
┌──────────┬──────────────────────────────────────────────────────┐
│ Sidebar  │                                                      │
│          │  Câu hỏi xếp lớp              [ 📥 Import ] [ + Tạo ]│
│          │                                                      │
│          │  Filters: Difficulty [▾ Tất cả]  Tag [▾ Tất cả]     │
│          │                                                      │
│          │  ┌── DataTable ───────────────────────────────────┐  │
│          │  │ Câu hỏi               │ Difficulty │ Tags  │ A  │  │
│          │  ├───────────────────────┼────────────┼───────┼────┤  │
│          │  │ HTML viết tắt của...  │ 🟢 Easy    │ html  │ ✏🗑│  │
│          │  │ CSS Flexbox dùng để.. │ 🟡 Medium  │ css   │ ✏🗑│  │
│          │  │ Closure trong JS là.. │ 🔴 Hard    │ js    │ ✏🗑│  │
│          │  └───────────────────────┴────────────┴───────┴────┘  │
│          │                                                      │
│          │  ← 1  2  3  →                                        │
└──────────┴──────────────────────────────────────────────────────┘
...
Import Dialog (same 2-step pattern as Question Banks):
  Step 1: Paste text → Step 2: Preview & confirm
```

---

### PAGE: Admin Course Detail (`/admin/courses/[courseId]`)
...
│          │                                                      │
│          │  ── Chương trình (read-only) ──                      │
│          │  Section 1: Giới thiệu (2 chapters, 5 lessons)      │
│          │  Section 2: Components (3 chapters, 12 lessons)     │
│          │                                                      │
│          │  ── Actions ──                                       │
│          │  [ ✅ Phê duyệt ]  [ ❌ Từ chối ]  (if pending)     │
│          │                                                      │
└──────────┴──────────────────────────────────────────────────────┘
```
...
### PAGE: Detailed Analytics (`/admin/analytics`)

```
Route:     /admin/analytics
Auth:      Admin
Rendering: Client Component (interactive charts, date range picker)
API:       GET /api/admin/analytics?range=...
```
...
│          │  Thống kê chi tiết                                   │
│          │                                                      │
│          │  Date range: [7 ngày] [30 ngày] [90 ngày] [Tùy chọn]│
│          │                                                      │
│          │  ┌───────────────────────────────────────────────┐   │
│          │  │  👥 Người dùng mới           (Area chart)     │   │
│          │  │  ▁▂▃▅▆▇█▇▆▅▃▂▁▂▃▅▆▇                         │   │
│          │  │  Tổng: 1,234 | Trung bình: 41/ngày            │   │
│          │  └───────────────────────────────────────────────┘   │
│          │                                                      │
│          │  ┌───────────────────────────────────────────────┐   │
│          │  │  💰 Doanh thu                (Line chart)      │   │
│          │  │  ▁▂▃▅▆▇█▇▆▅▃▂▁▂▃▅▆▇                         │   │
│          │  │  Tổng: 45.2M₫ | Trung bình: 1.5M/ngày        │   │
│          │  └───────────────────────────────────────────────┘   │
│          │                                                      │
│          │  ┌────────────────────┬──────────────────────────┐   │
│          │  │  📚 Đăng ký mới   │  📊 Khóa học mới         │   │
│          │  │  (Bar chart)       │  (Bar chart)             │   │
│          │  │  ▃▅▇▅▃▆▇▅▃▆      │  ▂▃▁▄▂▃▁▄▂▃             │   │
│          │  └────────────────────┴──────────────────────────┘   │
│          │                                                      │
