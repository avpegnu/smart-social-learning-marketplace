...
> Tổng cộng: **~90 endpoints** | Format: REST JSON | Auth: JWT Bearer Token
...
| Learning          | 8         | Progress, Quiz, Certificates, Placement        |
| Social            | 15        | Feed, Posts, Chat, Groups, Bookmarks           |
...
| Admin             | 12        | Approvals, Users, Reports, Analytics, Settings |
